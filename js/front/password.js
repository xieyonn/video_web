            ...
            $.ajax({
                type:"post",
          	    ...
          	    success:function(data){
          	        password_message.collapse('show').children('p').text(data).addClass('bg-success');
          	    },
